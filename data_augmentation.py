...
def apply_data_agumentation_to_train(train_path):
    ...
    for img_path in images:
        ...
        # print(image_h_flip.numpy().min(), image_h_flip.numpy().max())
        ...
        # print(image_v_flip.numpy().min(), image_v_flip.numpy().max())
        ...
        # # random rotation
        image_rotated = TF.rotate(image, angle=25.0)
        mask_rotated = TF.rotate(mask, angle=25.0)
        # print(image_rotated.numpy().min(), image_rotated.numpy().max())
